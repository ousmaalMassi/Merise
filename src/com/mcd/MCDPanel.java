...
public class MCDPanel extends JPanel {
    ...
    public void showExampleGraph() {
        ...
        entity2.setPropertyList(Arrays.asList(
                ...
                new Property("prix_vente", Property.Types.INT, 11, List.of(Property.Constraints.NOT_NULL)),
        ...
        association.addParty(entity1, Cardinalities.ONE_MANY);
        association.addParty(entity2, Cardinalities.ONE_ONE);
